...
void SortDescending(GeneralMatrix& GM)
{
   ...
   Real* data = GM.Store(); int maxi = GM.Storage();

   if (maxi > DoSimpleSort) MyQuickSortDescending(data, data + maxi - 1, 0);
   InsertionSortDescending(data, maxi, DoSimpleSort);
...
void SortAscending(GeneralMatrix& GM)
{
   ...
   if (maxi > DoSimpleSort) MyQuickSortAscending(data, data + maxi - 1, 0);
   InsertionSortAscending(data, maxi, DoSimpleSort);
